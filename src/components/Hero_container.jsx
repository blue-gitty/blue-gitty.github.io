...
function HeroSection() {
    ...
    return(
            <div className="hero-container">
               ...
               intracranial aneurysms is guided by a well-structured three-year plan, and we are actively seeking the 
               necessary resources, including capital, industry connections, and software expertise, to drive this innovation 
               forward and ultimately improve patient care and outcomes.
               </p>
